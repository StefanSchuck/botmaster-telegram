...
class TelegramBot extends BaseBot {
  ...
  __formatOutgoingTelegramTextRecursive(message) {
    if(message.includes(".")){
      message = message.replace(".","\\.");
      return this.__formatOutgoingTelegramTextRecursive(message);
  ...
  __formatOutgoingMessage(message) {
    ...
    if (message.message.text) {
      formattedMessage.text =this.__formatOutgoingTelegramTextRecursive(message.message.text);
